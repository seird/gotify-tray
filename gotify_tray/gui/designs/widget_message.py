...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        spacerItem = QtWidgets.QSpacerItem(0, 2, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Fixed)
        self.gridLayout_frame.addItem(spacerItem, 0, 3, 1, 4)
        ...
        self.gridLayout_frame.addItem(spacerItem1, 1, 4, 1, 1)
        self.browser_message = QtWidgets.QTextBrowser(parent=self.frame)
        self.browser_message.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.browser_message.setOpenExternalLinks(True)
        self.browser_message.setObjectName("browser_message")
        self.gridLayout_frame.addWidget(self.browser_message, 5, 3, 1, 4)
